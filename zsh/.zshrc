...
alias sshcplabmain="ssh -X s1333534@ph-cplab.ph.ed.ac.uk -t \"export TERM=xterm && tmux attach -t max-ssh || tmux new -s max-ssh\""
sshcplab () {
	ssh -X s1333534@ph-cplab.ph.ed.ac.uk -t "export TERM=xterm && ssh s1333534@cplab$1 -t \"export TERM=xterm && tmux attach -t max-ssh || tmux new -s max-ssh\"";}
